...
host mount. A manifest is untrusted until the pinned offline verifier returns
its private verifier receipt; a missing, expired, revoked, or unverified Gate A
manifest keeps the service in shadow mode.
